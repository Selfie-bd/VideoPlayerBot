...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data=="help":
        buttons = [
            ...
            [
                InlineKeyboardButton("MORE BOTS", url="https://t.me/groupdc/30"),
                InlineKeyboardButton("SOURCE CODE", url="https://github.com/selfie-bd/VideoPlayerBot"),
            ],
            [
