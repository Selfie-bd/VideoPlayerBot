...
async def not_chat(_, m: Message):
    buttons = [
            [
                InlineKeyboardButton("CHANNEL", url="https://t.me/umlinks"),
                InlineKeyboardButton("SUPPORT", url="https://t.me/groupdc"),
            ],
            [
                InlineKeyboardButton("MAKE YOUR OWN BOT", url="https://heroku.com/deploy?template=https://github.com/selfie-bd/VideoPlayerBot"),
            ]
         ]
    await m.reply_text(text="**Sorry, You Can't Use This Bot In This Group 🤷‍♂️! But You Can Make Your Own Bot Like This From The [Source Code](https://github.com/selfie-bd/VideoPlayerBot) Below 😉! Contact us @groupdc**", reply_markup=InlineKeyboardMarkup(buttons), disable_web_page_preview=True)
